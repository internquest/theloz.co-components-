...
const Footer = () => {
    ...
    const fistinview = useInView(firstpath)

    // const [first, setPathLengths] = useState([0, 0, 0])
            ...
            <footer className="border-t-0 aft750:py-28 aft750:px-36 py-14 px-8 bg-[rgb(24,24,27)] ">
                <div className='max-w-[128rem] w-full my-0 mx-auto p-0 '>
                    <div className='pb-20 gap-20 justify-center items-center flex-col flex'>
                        ...
                        <a href="" className='group aft750:w-[522px] aft750:h-[175px] justify-center flex m-auto' >
                            <motion.svg
                            ...
                            >
                                ...
                                <path
                                    ...
                                    style={{ strokeDashoffset: fistinview && 0 }}
                                    ref={firstpath}
                                    className={`[stroke-dasharray:974.7999267578125px] [stroke-dashoffset:974.7999267578125px] loz-footer-logo-1 group-hover:fill-[#74d2c2] group-hover:transition-all group-hover:duration-[.6s] group-hover:ease-in-out ![transition:fill_.6s_ease-in-out,stroke-dashoffset_1s_cubic-bezier(.47,0,.745,.715)_0s] `}

                                ></path>
                                <path
                                    fill="#18181b"
                                    stroke="#74d2c2"
                                    style={{ strokeDashoffset: isInView && 0 }}

                                    d="M807.4 5.7H552.8v85.7h115.3l-115.3 92.4v78.7h254.6v-85.4H691.5L807.4 85V5.7z"
                                    className={`group-hover:fill-[#74d2c2] group-hover:transition-all group-hover:duration-[.6s] group-hover:ease-in-out loz-footer-logo-2 ![transition:fill_.6s_ease-in-out,stroke-dashoffset_1s_cubic-bezier(.47,0,.745,.715)_2.2s] [stroke-dasharray:1365.294189453125px] [stroke-dashoffset:1365.294189453125px] `}
                                ...
                                <path
                                    ...
                                    className={`group-hover:fill-[#74d2c2] group-hover:transition-all group-hover:duration-[.6s] group-hover:ease-in-out loz-footer-logo-3 ![transition:fill_.6s_ease-in-out,stroke-dashoffset_1s_cubic-bezier(.47,0,.745,.715)_1.2s] [stroke-dasharray:1229.6441650390625px] [stroke-dashoffset:1229.6441650390625px] `}

                                ></path>
                            </motion.svg>
                        </a>
                    </div>
                    <div className='grid-cols-12 xl:grid-cols-11 gap-y-20 justify-between max-w-[80rem] grid mx-auto'>
                        <div className='xl:col-span-4 aft750:footer-block min-w-[310px] col-span-12'>
                            ...
                            <div className=''>
                                <p className='text-[rgb(82,82,91)] hidden xl:block text-[.875rem] leading-[1.25rem]'>
                                    © 2024{' '}
                                    <a href="/">Spring Innovations Inc.</a><br />

                                </p>
                                <p className='text-[rgb(82,82,91)] text-[.875rem] leading-[1.25rem] mt-[.5rem] hidden xl:block'>
                        ...
                        <div className='aft750:footer-block aft750:pl-[25%] col-span-6 xl:pl-0 xl:col-span-2'>
                        ...
                        <div className='xl:col-span-3 aft750:justify-start footer-block col-span-12'>
                            ...
                            <div className='text-center text-[rgb(212,212,216)] xl:text-left mx-auto xl:mx-0 text-[#212,212,216)] max-w-[300px]'>
                                <p>Manufactered in the United States with globally-sourced ingredients.</p>
                            </div>
                        </div>
                    </div>
                    <div className='text-center mt-[2.5rem]'>
                        <p className='text-[rgb(82,82,91)]  xl:hidden text-[.875rem] leading-[1.25rem]'>
                            © 2024{' '}
                            <a href="/">Spring Innovations Inc.</a><br />

                        </p>
                        <p className='text-[rgb(82,82,91)] text-[.875rem] leading-[1.25rem] mt-[.5rem]  xl:hidden'>
