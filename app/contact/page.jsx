...
const page = () => {
    return (
        <main>
            <div>
                <div className='lg:py-48 lg:px-44 aft750:-mb-28 py-[3rem] px-6 -mb-[3.5rem] z-10 relative'>
                    <div className=' my-0 mx-auto px-0 gap-16 flex-col flex max-w-[80rem] '>
                        <p className='leading-[1.75] aft750:text-[1.5rem] aft750:leading-[2rem] text-[rgb(39_39_42/1)] text-center whitespace-nowrap gap-[.875rem] items-baseline flex'> Contact
            ...
            <section>
                <div className='bg-white px-6 top-[-2.5rem] bg-fixed  lg:px-44 z-[11] relative text-[rgb(18,18,18.75)]  '>
                    <div className='pt-[27px] pb-[75px] px-0 aft750:pt-[36px] max-w-[80rem] aft750:pb-[100px] '>
                        <h2 className=' text-[28px]  mx-0 mb-[2rem] aft750:text-[56px] font-semibold  aft990:mb-[3rem] leading-[150%] aft750:leading-[125%] '>Contact</h2>
                        <form action="" className='relative z-0'>
                            <div className='aft750:grid aft750:grid-cols-2 aft750:gap-x-[2rem]'>
                                <div className=' after:absolute after:content-[""] after:pointer-events-none after:top-[0px] after:bottom-[0px] after:left-[0px] after:right-[0px] after:border-[.1rem] after:border-solid after:border-transparent after:transition-shadow after:duration-100 after:ease after:z-[1] after:rounded-[50px] after:shadow-[0_0_0_2px_rgb(18,18,18)] hover:after:shadow-[0_0_0_calc(.1rem+1px)_#6f7bd4] mb-[1.5rem] aft750:mb-[2rem] relative w-full flex'>
                            ...
                            <div className='mt-[3rem] aft750:mt-[4rem] '>
